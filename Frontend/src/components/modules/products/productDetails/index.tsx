...
const ProductDetails = ({ product }: { product: TLIsting }) => {
  ...
  return (
    <>
      ...
      <div className="mt-24 font-madimi border border-black/20 py-8 rounded-xl overflow-hidden grid grid-cols-1 md:grid-cols-7">
        {/* Left Side: Images and Details */}
        <div className="bg-white  col-span-1 md:col-span-4 px-6 md:pb-0 pb-8 border-b md:border-b-0 md:border-r border-neutral-300">
          {/* Image Carousel */}
        ...
        <div className="col-span-1 md:col-span-3 bg-white py-8 px-6">
