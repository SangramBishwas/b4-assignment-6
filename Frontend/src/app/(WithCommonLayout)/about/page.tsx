const AboutPage = () => {
  return (
    <div className="bg-gray-50 font-madimi px-4 py-10 md:px-12 lg:px-32 my-12">
      <div className="max-w-4xl border border-black mx-auto bg-white rounded-2xl p-6 md:p-10 space-y-6">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
          About Us
        </h1>
        <p className="text-gray-600 text-lg leading-relaxed">
          Welcome to <span className="font-semibold text-black font-lobster">AsMart</span> —
        ...
        <div className="pt-6 border-t border-t-black text-sm text-gray-500">
